...
<div class="min-h-screen bg-white py-12">
    <div class="max-w-xl mx-auto px-4">
        ...
        <!-- Formulario -->
        <form action="<?php echo e(route('payment.process')); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\bodyskin\resources\views/payment/checkout.blade.php ENDPATH**/ ?>